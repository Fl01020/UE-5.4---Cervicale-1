...
Module interactif de simulation clinique pour la formation en chiropraxie. L'étudiant mène une anamnèse libre, analyse les données, conduit un examen clinique et raisonne jusqu'au diagnostic fonctionnel.
